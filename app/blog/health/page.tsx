...
export const metadata: Metadata = {
  title: "Health Stories — Mamta Bhajipale",
  description:
    "Stories from public health work across India's primary care system.",
};
    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-blog-beige)" }}>
      ...
      >
        <Link
          ...
          style={{ color: "var(--color-blog-health)" }}
        >
          <ArrowLeft size={16} />
          All Stories
        </Link>
